  ...
  try {
    ...
    const { text } = await generateText({
      ...
      **User's Answer:** ${userAnswer}
      ...
      Prioritize the user's anser only if it,s correct. If it's incomplete or incorrect, improve or correct it while keeping the response concise and to the point.
